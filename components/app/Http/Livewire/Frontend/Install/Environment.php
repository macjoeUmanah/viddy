...
class Environment extends Component
{
    ...
    public function checkDatabaseConnection($database_name, $database_username, $database_password){
    ...
    public function onCreateDatabase(){
        ...
        try {
            ...
            if ($deJson->status == 'success') {
                ...
                if (! $this->checkDatabaseConnection($this->database_name, $this->database_username, $this->database_password) ) {
