                                  ...
                                  <div class="col-lg-4 col-sm-6">
                                    <div class="card card-plain card-blog">
                                      ...
                                      <div class="card-body px-0">
                                        <h5>
                                          <a href="{{ url('/') . '/' . $pageTran->slug }}" class="text-dark font-weight-bold">{{ $pageTran->title }}</a>
                                        </h5>
                                        <p>{{ $pageTran->short_description }}</p>

                                        <a href="{{ url('/') . '/' . $pageTran->slug }}" class="text-info icon-move-right">{{ __('Read More') }}
