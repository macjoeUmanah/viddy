	<div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link {{ Route::is('general', 'menu', 'header', 'footer', 'create-footer-translations', 'edit-footer-translations', 'api-keys', 'json', 'gdpr', 'advertisement', 'smtp', 'translations', 'edit-translations', 'advanced') ? 'active' : '' }}" data-bs-toggle="collapse" href="#theme-settings" role="button" aria-expanded="{{ Route::is('general', 'menu', 'header', 'footer', 'api-keys', 'json', 'gdpr', 'advertisement', 'translations', 'edit-translations', 'advanced') ? 'true' : 'false' }}" aria-controls="theme-settings">
					<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
				...
				<ul class="collapse multi-collapse {{ Route::is('general', 'menu', 'header', 'footer', 'create-footer-translations', 'edit-footer-translations', 'api-keys', 'json', 'gdpr', 'advertisement', 'smtp', 'translations', 'edit-translations', 'advanced') ? 'show' : '' }}" id="theme-settings">
