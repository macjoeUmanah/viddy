    ...
    <div class="col-12">
      ...
      <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
        <div class="container-fluid">
          <a class="navbar-brand font-weight-bolder ms-sm-3" title="{{ __('VidClear') }}" href="{{ route('home') }}">
                           ...
                           @foreach(localization()->getSupportedLocales() as $localeCode => $properties)
                            ...
                            @php
                              $mobileLangMenu .='<h6 class="dropdown-header text-dark font-weight-bolder px-0">
                                      <img src="'.asset('assets/img/flags/' . $properties->key() . '.svg').'" class="lang-menu me-1 my-auto"> <a href="'.localization()->getLocalizedURL($properties->key(), null, [], true).'">'.$properties->native().'</a>
                                     </h6>';
                            @endphp
