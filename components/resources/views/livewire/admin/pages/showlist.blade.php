								...
								@foreach ($pages as $page)
									...
									<tr>
										...
										<td class="align-middle w-25">
											<a href="{{ route('page-translations', $page->id ) }}" class="btn btn-sm btn-primary" title="{{ __('Translations') }}"><i class="fas fa-language fa-fw"></i> Translations</a>
											<a wire:click="onShowEditPageModal( {{ $page->id }} )" class="btn btn-sm btn-info" title="{{ __('Edit') }}"><i class="fas fa-edit fa-fw"></i> {{ __('Edit') }}</a>
											<a wire:click="onDeleteConfirmPage( {{ $page->id }} )" class="btn btn-sm btn-danger" title="{{ __('Delete') }}"><i class="fas fa-trash fa-fw"></i> {{ __('Delete') }}</a>
										</td>
									</tr>
