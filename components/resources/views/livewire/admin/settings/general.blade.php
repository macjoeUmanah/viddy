				...
				<div class="card">
					<div class="card-body">
						<table class="table settings">
							...
							<tr>
								<td><label for="wave-animation-status" class="form-label">{{ __('Enable Wave Animation') }}</label></td>
								<td class="w-75">
							...
							<tr>
								<td><label for="parallax-image" class="form-label">{{ __('Parallax Image') }}</label></td>
								<td>
							...
							<tr>
								<td><label for="social" class="form-label">{{ __('Overlay Type') }}</label></td>
								<td>
							...
							@if ( $overlay_type == 'solid' )
								...
								<tr>
									<td><label for="color_picker" class="form-label">{{ __('Choose Solid Color') }}</label></td>
									<td><input class="form-control form-control-color" id="color_picker" wire:model="solid_color" type="color"></td>
								</tr>

							@elseif( $overlay_type == 'gradient' )

								<tr>
									<td><label for="ads-area-1" class="form-label">{{ __('Choose Gradient Color') }}</label></td>
									<td>
										<table class="table">
											<tr>
												<td><input class="form-control form-control-color" wire:model="gradient_first_color" type="color"></td>
												<td><input class="form-control form-control-color" wire:model="gradient_second_color" type="color"></td>
												<td>
							...
							<tr>
								<td><label for="opacity" class="form-label">{{ __('Opacity') }}</label></td>
								<td>
									<div class="w-100">
							...
							<tr>
								<td><label for="blur" class="form-label">{{ __('Blur') }}</label></td>
								<td>
									<div class="w-100">
				...
				<div class="card">
					<div class="card-body">
							...
							<table class="table settings">
								...
								<tr>
									<td><label for="page-load" class="form-label">{{ __('Enable Page Load') }}</label></td>
									<td>
										<div class="form-check form-switch ps-0">
								...
								<tr>
									<td><label for="share-icons-status" class="form-label">{{ __('Enable Share Icons') }}</label></td>
									<td>
										<div class="form-check form-switch ps-0">
								...
								<tr>
									<td><label for="supported-sites" class="form-label">{{ __('Enable Supported Sites') }}</label></td>
									<td>
										<div class="form-check form-switch ps-0">
								...
								<tr>
									<td><label for="author-box-status" class="form-label">{{ __('Enable Author Box') }}</label></td>
									<td>
										<div class="form-check form-switch ps-0">
								...
								<tr>
									<td><label for="timezone" class="form-label">{{ __('Timezone') }}</label></td>
									<td wire:ignore>
								...
								<tr>
									<td><label for="font_family" class="form-label">{{ __('Font Family') }}</label></td>
									<td wire:ignore>
