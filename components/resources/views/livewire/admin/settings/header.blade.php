		...
		<div class="card">
			<div class="card-body">
				<table class="table settings">
						...
						<tr>
							<td><label for="logo" class="form-label">{{ __('Logo') }}</label></td>
							<td>
						...
						<tr>
							<td><label for="favicon" class="form-label">{{ __('Favicon') }}</label></td>
							<td>
								<div class="input-group">
									<span class="input-group-btn">
						...
						<tr>
							<td><label for="sticky-header" class="form-label">{{ __('Sticky Header') }}</label></td>
							<td>
