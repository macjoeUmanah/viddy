                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    @if ( !empty($translations) )
                                        ...
                                        <tr>
                                            <td><input type="text" class="form-control" wire:model.defer="translations.{{ $index }}.key" readonly></td>
                                            <td><input type="text" class="form-control" wire:model.defer="translations.{{ $index }}.value" wire:ignore></td>
                                            <td><a title="Delete" class="float-end" href="javascript:;" wire:click="onDeleteTranslation({{ $translation['id'] }})"><i class="fas fa-trash"></i></a></td>
                                        </tr>
                                        @endforeach
