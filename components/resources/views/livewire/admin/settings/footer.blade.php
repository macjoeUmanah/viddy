                                ...
                                @foreach ($footer_translations as $footer_translation)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle w-25">
                                            <a href="{{ localization()->getLocalizedURL($footer_translation->locale, route('edit-footer-translations', $footer_translation->id), [], true) }}" class="btn btn-sm btn-primary" title="{{ __('Edit') }}"><i class="fas fa-edit"></i> {{ __('Edit') }}</a>
                                            <a wire:click="onDeleteConfirmFooterTranslation( {{ $footer_translation->id }} )" class="btn btn-sm btn-danger" title="{{ __('Delete') }}"><i class="fas fa-trash fa-fw"></i> {{ __('Delete') }}</a>
                                        </td>
                                    </tr>
